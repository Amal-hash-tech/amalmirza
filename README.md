...
pie title AI/ML Skill Distribution
    "Python & C/C++": 15
    "Deep Learning (PyTorch, TensorFlow, CNN, GAN)": 15
    "NLP & LLMs (BERT, RoBERTa, GPT, LLaMA)": 20
    "LangChain & RAG Systems": 10
    "Computer Vision (OpenCV, YOLO-series, ViT)": 15
    "Cybersecurity AI & Malware Detection": 10
    "MLOps & Deployment (Docker, Kafka, OpenSearch)": 10
    "Embedded Systems (Arduino, Raspberry Pi)": 5
```
> Main tools:
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=amalmirza&style=flat-square" alt="Profile views" />
  <img src="https://img.shields.io/github/followers/amalmirza?label=Followers&style=social" />
</p>
